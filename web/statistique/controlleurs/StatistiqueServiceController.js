angular.module('StatistiqueModule').controller('StatistiqueServiceController', function ($scope,$rootScope,SweetAlert,
$routeParams, Entite,GroupeTypeEmploye, $q, StatistiqueEntite) {
