angular.module('StatistiqueModule').controller('StatistiqueDRHEntiteController', function ($scope,$rootScope,
SweetAlert, $cookies, $q, Entite,GroupeTypeEmploye, StatistiqueEntite) {
