...
//        console.log(SweetAlert.confirmerAction("Attention", "Voulew vous vraiement supprimer cet élément ?"))
//        if (SweetAlert.confirmerAction("Attention", "Voulew vous vraiement supprimer cet élément ?") == true) {
//            console.log("action confirmee");
//        } else {
