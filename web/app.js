 ...
 */
angular.module('globalModule',['ngRoute','ngMessages','EmployeModule','ngCookies','angularFileUpload','data-table','DrhModule','ParametrageModule','AuthentificationModule','StatistiqueModule']);
