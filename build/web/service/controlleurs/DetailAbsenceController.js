...
angular.module('ServiceModule').controller('DetailAbsenceController', function ($scope, $rootScope, $routeParams , $q,SweetAlert,
        Employe, Absence,Servir)
{

console.log($routeParams.id);
//    Employe.find($routeParams.id).success(function (data) {
//            $scope.employe = data;
//        }).error(function () {
...
//        });
    ...
    $scope.fonctionEmploye = function(){
        console.log("$scope.absence.employe :"+$scope.absence.employe.id);
