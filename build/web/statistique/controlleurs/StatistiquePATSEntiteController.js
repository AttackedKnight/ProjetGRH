 ...
 //            }
     ...
     /*Trache age*/
         ...
         $scope.getEffectifTrancheAgeHomme=function (date1,date2){
             StatistiqueEntite.trancheagehommespatsEntite($scope.entiteChoisie,date1,date2).success(function (data){
                 return data;             
             }).error(function () {
                 alert('Une erreur est survenue');
             });
          ...
          $scope.getEffectifTrancheAgeFemme=function (date1,date2){          
             StatistiqueEntite.trancheagefemmespatsEntite($scope.entiteChoisie,date1,date2).success(function (data){
                 return data;
             }).error(function () {
                 alert('Une erreur est survenue');
             });          
